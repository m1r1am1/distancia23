...
/**
 * @internal Función que devuelve el resultado de la suma de dos números pasados como parámetros.
...
/**
 * @internal Función que devuelve el resultado de la resta de dos números pasados como parámetros.
